...
# weights = glob.glob('./checkpoints/confthres_0.9_lr_0.01/source_encoder/weights/116.*')
val_recall = {}
val_prec = {}
val_F1 = {}
...
for epoch in range(17):
    ...
    weights_path = './checkpoints/confthres_0.9_lr_0.01/target_encoder/encoder_weights/' + str(epoch) + '.weights'
    # weights_path = './checkpoints/confthres_0.9_lr_0.01/source_encoder/weights/116.weights'
    ...
    with open('./checkpoints/confthres_0.9_lr_0.01/target_encoder/test/val_recalls.txt', 'a') as f:
        # epoch = k
        # recall = str(val_recall[k])
        f.write(str(avg_recall) + '\n' )


    with open('./checkpoints/confthres_0.9_lr_0.01/target_encoder/test/val_precs.txt', 'a') as f:
        # epoch = k
        # prec = str(val_prec[k])
        f.write(str(avg_prec) + '\n' )


    with open('./checkpoints/confthres_0.9_lr_0.01/target_encoder/test/val_F1.txt', 'a') as f:
        # epoch = k
        # F1 = str(val_F1[k])
        f.write(str(avg_F1) + '\n' )
